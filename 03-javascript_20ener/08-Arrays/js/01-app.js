...
// Para Javascript son tipos de datos complejos en los que una variable puede tener diferentes valores.
...
//actual presentación
const tercerArray = ["Uno", "segundo", 90, 15, , , "cincuenta"]; //FORMA en la que más y mejor se trabaja
...
//// el segundo parametro indica cuantos  elementos vamos a borrar, 0 significa nada, entonces seria igual a no tener nada, si no le pasas un valor va a borrar todos a partir de ahi..
carrito.splice(1, 2);
...
// ForEach   VER ES INTERESANTE Metodo que permite aplicar una función
